alert(
  "Lets play Rock, Paper, Scissors! (Game is Best of Five) \nType answer exactly as shown..."
);

class player {
  constructor(score, choice) {
    this.score = score;
    this.choice = choice;
...
function playRound() {
  {
    if (newPlayer.choice === computer.choice) {
      alert(
        `It's a tie!!! \nPlayer's choice = ${newPlayer.choice} \nComputer's choice = ${computer.choice}`
      );
      computer.score = computer.score + 1;
      newPlayer.score = newPlayer.score + 1;
    } else if (newPlayer.choice === "rock" && computer.choice === "scissors") {
      alert(
        `Player wins!!! \nPlayer's choice = ${newPlayer.choice} \nComputer's choice = ${computer.choice}`
      );
      newPlayer.score = newPlayer.score + 1;
    } else if (newPlayer.choice === "rock" && computer.choice === "paper") {
      alert(
        `Computer wins!!! \nPlayer's choice = ${newPlayer.choice} \nComputer's choice = ${computer.choice}`
      );
      computer.score = computer.score + 1;
    } else if (newPlayer.choice === "paper" && computer.choice === "scissors") {
      alert(
        `Computer wins!!! \nPlayer's choice = ${newPlayer.choice} \nComputer's choice = ${computer.choice}`
      );
      computer.score = computer.score + 1;
    } else if (newPlayer.choice === "paper" && computer.choice === "rock") {
      alert(
        `Player wins!!! \nPlayer's choice = ${newPlayer.choice} \nComputer's choice = ${computer.choice}`
      );
      newPlayer.score = newPlayer.score + 1;
    } else if (newPlayer.choice === "scissors" && computer.choice === "paper") {
      alert(
        `Player wins!!! \nPlayer's choice = ${newPlayer.choice} \nComputer's choice = ${computer.choice}`
      );
      newPlayer.score = newPlayer.score + 1;
    } else if (newPlayer.choice === "scissors" && computer.choice === "rock") {
      alert(
        `Computer wins!!! \nPlayer's choice = ${newPlayer.choice} \nComputer's choice = ${computer.choice}`
      );
      computer.score = computer.score + 1;
...
let winner =
  newPlayer.score > computer.score
    ? `Player Wins: \nPlayer's Score = ${newPlayer.score}`
    : newPlayer.score < computer.score
    ? `Computer wins: \nComputer's Score = ${computer.score}`
    : `It's a tie! \nPlayer's Score = ${newPlayer.score} \nComputer's Score = ${computer.score}`;
